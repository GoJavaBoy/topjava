...
//        @NamedQuery(name = User.MEALS, query = "SELECT m FROM Meal m WHERE m.user.id=:id") // Additional variant
})
@Entity
...
//    public static final String MEALS = "User.getAllMeals"; // Additional variant
